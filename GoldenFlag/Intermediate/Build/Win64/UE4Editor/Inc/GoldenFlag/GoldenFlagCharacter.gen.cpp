...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AGoldenFlagCharacter()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ProjectileOffset_MetaData[] = {
				{ "Category", "Projectile" },
				{ "ModuleRelativePath", "GoldenFlagCharacter.h" },
				{ "ToolTip", "Projectile offset from camera" },
			};
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_ProjectileOffset = { UE4CodeGen_Private::EPropertyClass::Struct, "ProjectileOffset", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000010001, 1, nullptr, STRUCT_OFFSET(AGoldenFlagCharacter, ProjectileOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(NewProp_ProjectileOffset_MetaData, ARRAY_COUNT(NewProp_ProjectileOffset_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Mesh3P_MetaData[] = {
				...
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "GoldenFlagCharacter.h" },
				{ "ToolTip", "Pawn mesh: 3rd person view (seen only by others)" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Mesh3P = { UE4CodeGen_Private::EPropertyClass::Object, "Mesh3P", RF_Public|RF_Transient|RF_MarkAsNative, 0x00400000000b0009, 1, nullptr, STRUCT_OFFSET(AGoldenFlagCharacter, Mesh3P), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(NewProp_Mesh3P_MetaData, ARRAY_COUNT(NewProp_Mesh3P_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FireSound,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ProjectileOffset,
	...
	IMPLEMENT_CLASS(AGoldenFlagCharacter, 49662295);
